...
void print_entry(unsigned long int e_enty, unsigned char *e_ident);
...
/**
 * main - display information in elf header of elf file
 * @argc: argument count
 * @argv: argument vector
 * Return: 0 for success
 * Description: if file not elf file or function fail exit 98
 */
